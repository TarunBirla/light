                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="d-flex gap-4 align-items-center mt-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="is_sell" id="is_sell" value="1" {{ old('is_sell', '1') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label fw-semibold" for="is_sell">
                                     Sell
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="is_rental" id="is_rental" value="1" {{ old('is_rental', '1') == '1' ? 'checked' : '' }}>
