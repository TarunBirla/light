...
.product-type-tab.active-rental {
        ...
        <div class="mb-4">
            ...
            <div class="category-scroll">
                ...
                @foreach($categories as $cat)
                    ...
                    <a href="{{ url('/category/' . $cat->id . '?' . http_build_query(array_merge(request()->query(), ['type' => $productType ?? 'sell']))) }}"
    ...
    <h3 class="fw-bold mb-3">
        {{ $category->name }} ({{ ($productType ?? 'sell') == 'sell' ? 'Selling Products' : 'Rental Products' }})
    </h3>
    <div class="row mb-4">
    <div class="col-md-6">
